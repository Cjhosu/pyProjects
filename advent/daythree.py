...
newlist =({0: 0},{-30: 776},{-26: 966},{539: 1880},{280: 2577},{-56: 2577},{-131: 2281},{-579: 1687},{-584: 1687},{-662: 1872},{-662: 1922},{-662: 1978},{-56: 2317},{90: 2688},{-1877: 3966},{-2256: 3966},{-2256: 4008},{-1877: 4008},{-4285: 4018},{-4048: 4005},{-3844: 4005},{-3344: 4229},{-3344: 4522},{-3344: 4781})
...
class Coordinator:
    coordinates = {0:0}
    xcounter = 0
    def movement(self, step, coord_list, listnum):
        step_val = int(step[1:])
        if 'R' in step:
            for key,value in self.coordinates.items():
                for x in range(0,step_val):
                    key += 1
                    self.xcounter += 1
                    self.coordinates = {key:value}
                    coord_list.append(self.coordinates)
                    if self.coordinates in newlist:
                        print(self.xcounter)
                        print(listnum)
...
for step in path1:
    Coordinator.movement(Coordinator, step, coord_list1, 'list1')

Coordinator.coordinates = {0:0}
Coordinator.xcounter = 0

for step in path2:
    Coordinator.movement(Coordinator, step, coord_list2, 'list2')

for x in coord_list1:
    if x in coord_list2:
        print(x)
